...
int main()
{
    ...
    int id;
    set_employees(employees, 2);
    print_employees(employees, 2);
    printf("Enter a employee's id:");
    scanf("%d", &id);
    int idx = find_employee(employees, 2, id);
    if (idx != -1)
    {
